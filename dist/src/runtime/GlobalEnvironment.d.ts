...
export declare const defaultValueEvaluator: (symbolTable: SymbolTable, expr: string, ignoreVariables?: string[]) => VariableValueType;
export declare const setValueEvaluator: (newEvaluator: (symbolTable: SymbolTable, expr: string) => VariableValueType) => void;
export declare const evaluate: (symbolTable: SymbolTable, expr: string, ignoreVariables?: string[]) => VariableValueType;
